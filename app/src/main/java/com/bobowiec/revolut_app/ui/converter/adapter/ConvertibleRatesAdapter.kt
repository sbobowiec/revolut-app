package com.bobowiec.revolut_app.ui.converter.adapter
...
import kotlinx.android.synthetic.main.view_convertible_rate_item.view.*
import java.math.BigDecimal

class ConvertibleRatesAdapter(
  ...
  inner class ViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
      parent.inflate(R.layout.view_convertible_rate_item)) {
